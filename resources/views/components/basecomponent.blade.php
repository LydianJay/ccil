...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <!-- Sidebar Start -->
        <div class="sidebar pe-4 pb-3 border-end border-dark border-1 rounded-4">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    @foreach (config('menu') as $key => $m)
                        <a href="{{ route($m['route']) }}" class="nav-item nav-link"><i
                            class="{{ $m['icon'] }}"></i>{{ $key }}</a>
                    @endforeach
    ...
    <script
        src="{{ asset('assets/thirdparty/dashmin') }}/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
